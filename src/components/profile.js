...
import profile_image from '../images/image2.webp'
...
const Profile =(props) =>{ 
    return(
      <div class="col-xs-12 col-sm-12 col-md-6 ">
        ...
        <div className="card profile  profile1">
            <div class="image_div ">
        ...
        <div class="card-body mt-5">
          ...
          <p class="card-text">  at Appsdeployer | MERN Full-Stack-Developer</p>
        </div>
        <ul class="list-group list-group-flush text-left info">
